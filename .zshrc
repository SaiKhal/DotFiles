...
plugins=(
  git
  zsh-autosuggestions
  zsh-syntax-highlighting # This plugin must be last
)
...
#####################################
#     fzf neovim fuzzy finder       #
#####################################

[ -f ~/.fzf.zsh ] && source ~/.fzf.zsh


# By default fzf will search the home directory
export FZF_DEFAULT_COMMAND="fd . $HOME"

# CTRL-T to copy path of selected file
